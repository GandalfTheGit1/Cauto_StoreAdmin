...
const validationSchema = Yup.object().shape({
  name: Yup.string().required('Por Favor. Inroduzca su nombre.'),
  phone: Yup.string().required('Introduzca su Número de Teléfono'),
  email: Yup.string().email('Email Inválido').required('Introduzca su Email'),
...
const SignUpForm = (props: SignUpFormProps) => {
  ...
  const {
    disableSubmit = false,
    className,
    signInUrl = '/s/sign-in/' + subscriptionId,
    message = '',
    onSubmit,
  } = props

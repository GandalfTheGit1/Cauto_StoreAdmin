  ...
  return (
    <article className='prose dark:prose-invert mx-auto'>
      ...
      <p>
        ...
        styles is what you really want. You dont want to have to remove annoying
        margins every time you use a <code>p</code> element in a piece of your
        dashboard UI. And I doubt you really want your blog posts to use the
    ...
    <!-- ... -->
      ...
      <blockquote>
        <p>
          Typography is pretty important if you dont want your stuff to look
...
`}</code>
      ...
      <p>
        ...
        dont even let you do it, but I guess since some of you goofballs are
      ...
      <ol>
        ...
        <li>
          ...
          <ul>
            <li>
              Again please dont nest lists if you want people to actually read
              your content.
            </li>
      ...
      <p>
        ...
        repository. I dont love that there is an underline below the backticks
      ...
      <p>
        But now we have. Please dont use <code>h5</code> or <code>h6</code> in
      ...
      <h4>
        Let's make sure we dont screw that up with <code>h4</code> elements,
        either.
      </h4>
      <p>

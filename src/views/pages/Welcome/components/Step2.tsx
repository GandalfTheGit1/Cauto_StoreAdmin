            ...
            return (
              <Form>
                ...
                <FormContainer>
                  ...
                  <FormItem label='Logo de la Empresa (Opcional)'>
                    <input
                      title='storeLogo'
                      type='file'
                      multiple
                      ...
                      onChange={(e: any): void => {
                        ...
                        axios
                          .post(
                            import.meta.env.VITE_SERVER + 'upload/shopIcon',
                            formData
                          )
                          .then(res => {
                            setStoreData((prevState: StoreData) => ({
                              ...prevState,
                              storeLogo: res.data.fileName,
                            }))
                  ...
                  <FormItem
                    label='Municipio'
                    invalid={errors.township && touched.township}
                    ...
                    <Field name='township'>
                      {({ field, form }: FieldProps) => (
                        <Select
                          ...
                          options={sizes}
                          value={sizes.filter(
                            size => size.value === values.township
                          )}
                          onChange={size =>

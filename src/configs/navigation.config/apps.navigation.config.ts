      ...
      },
      {
        ...
        subMenu: [
          ...
          },
          {
            ...
            translateKey: 'nav.appsSales.productManagement',
            icon: '',
            type: NAV_ITEM_TYPE_ITEM,
            authority: [OWNER],
            subMenu: [],
          ...
          },
          {
            ...
            translateKey: 'nav.appsSales.orderManagement',
            icon: '',
            type: NAV_ITEM_TYPE_ITEM,
            authority: [OWNER],
            subMenu: [],
          },
          {
            ...
            translateKey: 'nav.appsCRM.crmManagement',
            icon: '',
            type: NAV_ITEM_TYPE_ITEM,
            authority: [OWNER],
            subMenu: [],
          },
          {
            ...
            translateKey: 'nav.appsInventory.inventoryManagement',
            icon: '',
            type: NAV_ITEM_TYPE_ITEM,
            authority: [OWNER],
            subMenu: [],
